...
public abstract class AbstractBeanDefinitionAssemble implements IBeanDefinitionAssemble {
    ...
    @Override
    public void assembleFactoryBean(Class<?> clazz, Map<String, BeanDefinition> beanDefinitions) {
        for (Method method : clazz.getDeclaredMethods()) {
            ...
            if (bean != null) {
                ...
                BeanDefinition beanDefinition = new BeanDefinition(beanClass, beanName, factoryBeanName, method, order,
